            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<Row>(_list32.size);
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  Row _elem34; // required
                  _elem34 = new Row();
                  _elem34.read(iprot);
                  struct.rows.add(_elem34);
                }
                iprot.readListEnd();
              }
  ...
  private static class QueryResultTupleScheme extends TupleScheme<QueryResult> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryResult struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.rows = new ArrayList<Row>(_list37.size);
        for (int _i38 = 0; _i38 < _list37.size; ++_i38)
        {
          Row _elem39; // required
          _elem39 = new Row();
          _elem39.read(iprot);
          struct.rows.add(_elem39);
        }
      }
      struct.setRowsIsSet(true);
    }
